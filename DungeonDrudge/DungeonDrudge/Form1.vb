Public Class Form1
    ...
    Dim TurtleMonkWeapon1 As Integer = 4
    Dim TurtleMonkWeapon2 As Integer = 5
    ...
    Private Sub SimplaCheckBox1_Click(sender As Object, e As EventArgs) Handles SimplaCheckBox1.Click
        ...
        If (number >= 3) Then
            MsgBox("You have rolled a 3+ ! Your armor save has been activated! ", MsgBoxStyle.Information, "DUNGEON DRUDGE")
        Else
            MsgBox("You have not rolled a 3+ ! Your armor save failed! ", MsgBoxStyle.Critical, "DUNGEON DRUDGE")
        End If
    End Sub
