Public Class Form4
    ...
    Dim TurtleMonkHealth As Integer = 3
    ...
    Private Sub RadioButtonTake1_Click(sender As Object, e As EventArgs) Handles RadioButtonTake1.Click
        ...
        MsgBox("You have taken 1 damage ! Your health is now " & TurtleMonkHealth & "/3", MsgBoxStyle.Critical, "DUNGEON DRUDGE")
    End Sub
    Private Sub RadioButtonTake2_Click(sender As Object, e As EventArgs) Handles RadioButtonTake2.Click
        ...
        Labelhealth.Text = TurtleMonkHealth
        SimplaProgressBar1.Value = TurtleMonkHealth
        MsgBox("You have taken 2 damage! Your health is now " & TurtleMonkHealth & "/3", MsgBoxStyle.Critical, "DUNGEON DRUDGE")
    End Sub
    Private Sub RadioButtonTake3_Click(sender As Object, e As EventArgs) Handles RadioButtonTake3.Click
        ...
        Labelhealth.Text = TurtleMonkHealth
        SimplaProgressBar1.Value = TurtleMonkHealth
        MsgBox("You have taken 3 damage! Your health is now " & TurtleMonkHealth & "/3", MsgBoxStyle.Critical, "DUNGEON DRUDGE")
    End Sub
    Private Sub RadioButtonTake4_Click(sender As Object, e As EventArgs)
        TurtleMonkHealth -= 4
        If TurtleMonkHealth <= 0 Then
            TurtleMonkHealth = 0
        End If
        Labelhealth.Text = TurtleMonkHealth
        SimplaProgressBar1.Value = TurtleMonkHealth
        MsgBox("You have taken 4 damage! Your health is now " & TurtleMonkHealth & "/3", MsgBoxStyle.Critical, "DUNGEON DRUDGE")
    End Sub
    Private Sub RadioButtonGain1_Click(sender As Object, e As EventArgs) Handles RadioButtonGain1.Click
        TurtleMonkHealth += 1
        If TurtleMonkHealth >= 3 Then
            TurtleMonkHealth = 3
        End If
        Labelhealth.Text = TurtleMonkHealth
        SimplaProgressBar1.Value = TurtleMonkHealth
        MsgBox("You have gained 1 health ! Your health is now " & TurtleMonkHealth & "/3", MsgBoxStyle.Information, "DUNGEON DRUDGE")
    End Sub
    Private Sub RadioButtonGain2_Click(sender As Object, e As EventArgs) Handles RadioButtonGain2.Click
        ...
        Labelhealth.Text = TurtleMonkHealth
        SimplaProgressBar1.Value = TurtleMonkHealth
        MsgBox("You have gained 2 health ! Your health is now " & TurtleMonkHealth & "/3", MsgBoxStyle.Information, "DUNGEON DRUDGE")
    End Sub
    Private Sub RadioButtonGain3_Click(sender As Object, e As EventArgs) Handles RadioButtonGain3.Click
        ...
        Labelhealth.Text = TurtleMonkHealth
        SimplaProgressBar1.Value = TurtleMonkHealth
        MsgBox("You have gained 3 health ! Your health is now " & TurtleMonkHealth & "/3", MsgBoxStyle.Information, "DUNGEON DRUDGE")
    End Sub
    ...
    Private Sub SimplaCheckBox1_Click(sender As Object, e As EventArgs) Handles SimplaCheckBox1.Click
        ...
        If (number >= 5) Then
            MsgBox("You have rolled a 5+ ! Your armor save has been activated! ", MsgBoxStyle.Information, "DUNGEON DRUDGE")
        Else
            MsgBox("You have not rolled a 5+ ! Your armor save failed! ", MsgBoxStyle.Critical, "DUNGEON DRUDGE")
        End If
    End Sub
